...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.tmpfiles.rules = [
      ...
      "d ${cfg.root}/notes/obsidian 0770 aegix aegix - -"
      ...
      "d ${cfg.root}/projects 0770 aegix aegix - -"
      "d ${cfg.root}/sessions 0770 aegix aegix - -"
      "d ${cfg.root}/receipts 0770 aegix aegix - -"
      "d ${cfg.root}/approvals 0770 aegix aegix - -"
      ...
      "d ${cfg.root}/scratch 0770 aegix aegix - -"
    ];
